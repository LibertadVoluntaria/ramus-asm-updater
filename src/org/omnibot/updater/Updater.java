...
public class Updater extends Thread implements Runnable {
	...
	private void generateModscript() {
		try {
			...
			stream.writeString("ramus-omnibot-v1.ms");
	...
	private void loadContainers() {
		...
		try {
			final List<Class<?>> classes = Package.getClasses("org.omnibot.updater.container");
